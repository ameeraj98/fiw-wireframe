    ...
    <div className="bg-base-300 min-h-screen">
      ...
      <section className="py-24 bg-base-200 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 text-center lg:text-left">
          ...
          <p className="mt-4 text-xl opacity-70 max-w-2xl leading-relaxed">
            ...
            {/* 3. ENVIRONMENTAL TRUST - The Financial Commitment */}
      <section className="py-24 bg-base-300">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black uppercase mb-8">Environmental Trust</h2>
          <p className="text-xl opacity-80 leading-relaxed">
            We believe in accessibility. That’s why **15% of our net profit** is donated to the <span className="text-emerald-500 font-bold underline decoration-emerald-500/30">Future is Wild Environmental Trust</span>, funding for ecological restoration and community stewardship.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { label: "Trees Planted", value: "12,450", sub: "Native species established" },
            { label: "CO2 Offset", value: "310 Tons", sub: "Calculated annual sequestration" },
            { label: "Hectares Restored", value: "85 Ha", sub: "Dart Valley buffer zone" }
          ].map((metric, i) => (
